...
class CreateSolidQueueTables < ActiveRecord::Migration[8.0]
  def change
    create_table :solid_queue_jobs do |t|
      ...
      t.index %i[scheduled_at finished_at], name: 'index_solid_queue_jobs_on_scheduled_at'
    end
    ...
    create_table :solid_queue_processes do |t|
      ...
      t.references :supervisor, index: true,
                                foreign_key: { to_table: :solid_queue_processes, on_delete: :nullify }
      ...
      t.index %i[name supervisor_id], name: 'index_solid_queue_processes_on_name_and_supervisor_id'
    end
